function tableThresholdClustering_similarity()
    clearvars -except
    ...
    startFlowSimilarity = 0.1;
    endFlowSimilarity = 0.9;
    x_axis = startFlowSimilarity:0.1:endFlowSimilarity;
    x_label = 'Flow Similarity';
    ...
    for frequency = 1:roundNumber
        ...
        for flowSimilarity = startFlowSimilarity:0.1:endFlowSimilarity
