...
for frequency = 1:roundNumber
    ...
    if frequency == 1
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_1, allRound_y_axis_flowTableSize_perFlow, 1, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_2, allRound_y_axis_flowTableSize_perFlow, 2, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_3, allRound_y_axis_flowTableSize_perFlow, 3, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_4, allRound_y_axis_flowTableSize_perFlow, 4, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_5, allRound_y_axis_flowTableSize_perFlow, 5, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_6, allRound_y_axis_flowTableSize_perFlow, 6, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_7, allRound_y_axis_flowTableSize_perFlow, 7, frequency)
        drawFlowTableSizeFigure(x_axis, allRound_y_axis_flowTableSize_8, allRound_y_axis_flowTableSize_perFlow, 8, frequency)
        
        drawNetworkThroughputFigure(x_axis, allRound_y_axis_networkThroughput, allRound_y_axis_networkThroughput_perFlow, frequency)
    else
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_1), mean(allRound_y_axis_flowTableSize_perFlow), 1, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_2), mean(allRound_y_axis_flowTableSize_perFlow), 2, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_3), mean(allRound_y_axis_flowTableSize_perFlow), 3, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_4), mean(allRound_y_axis_flowTableSize_perFlow), 4, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_5), mean(allRound_y_axis_flowTableSize_perFlow), 5, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_6), mean(allRound_y_axis_flowTableSize_perFlow), 6, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_7), mean(allRound_y_axis_flowTableSize_perFlow), 7, frequency)
        drawFlowTableSizeFigure(x_axis, mean(allRound_y_axis_flowTableSize_8), mean(allRound_y_axis_flowTableSize_perFlow), 8, frequency)
        
        drawNetworkThroughputFigure(x_axis, mean(allRound_y_axis_networkThroughput), mean(allRound_y_axis_networkThroughput_perFlow), frequency)
    end
end
