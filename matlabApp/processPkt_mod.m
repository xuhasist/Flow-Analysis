function [final_path, sw_struct, link] = processPkt_mod(g, link, link_bwd_unit, link_if, host_ip, sw_struct, preLower, link_struct, flow_entry, flow, final_path, flow_start_datetime, src_edge_sw, dst_edge_sw, dst_name)
    ...
    if ~any(flow_compare)
        ...
        if new_flow_start_time - old_flow_end_time > seconds(60)
            ...
            [final_path, sw_struct, link] = processPkt_mod(g, link, link_bwd_unit, link_if, host_ip, sw_struct, preLower, link_struct, flow_entry, flow, final_path, flow_start_datetime, src_edge_sw, dst_edge_sw, dst_name);
        end
    end
end
